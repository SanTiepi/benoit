 ...
 */
function toStructured(prose, context = {}) {
  const result = {
    meta: {
 ...
 */
function comparePrompts(promptA, promptB) {
 ...
 */
function encodePrompt(userText, opts = {}) {
 ...
 */
function pipeline(userText, opts = {}) {
 ...
 */
function analyzeBatch(prompts, opts = {}) {
 ...
 */
function detectOverspec(prompt) {
 ...
 */
function languageEfficiency(text) {
